...
public class YouseeBornTest {

	@Test
	public static void testBorn() throws IOException, InterruptedException{
...
*/		
		...
		driver.findElement(By.xpath("//span[contains(text(),'Børn')]")).click();
